#ifndef READ_SIESTA_CROPPED_HPP
#define READ_SIESTA_CROPPED_HPP
...
class Read_Siesta_Cropped: public Device{
...
private:
  bool print_CSR = true;
  SpMatrixXp H_, vx_;
  SpMatrixXcp Hc_, vxc_, vyc_, szvy_; 
...
public:
  ~Read_Siesta_Cropped(){};
  Read_Siesta_Cropped(device_vars& );
  ...
  void trimBlocks(SpMatrixXcp& , const SpMatrixXcp& , int , int );
  ...
  virtual void setup_spinCurrentOp();
  ...
  virtual void vel_op_szvy (type*, type*);
